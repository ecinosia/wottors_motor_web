...
import 'package:wottors_motor_web/firestore/get_product_details_desktop.dart';
import 'package:wottors_motor_web/screens/desktop_screens/categories/new_filter.dart';
...
class CikmaUrunlerD extends StatefulWidget {
  const CikmaUrunlerD({super.key});

  @override
  State<CikmaUrunlerD> createState() => _CikmaUrunlerDState();
}

class _CikmaUrunlerDState extends State<CikmaUrunlerD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['status'] == 'Çıkma Orijinal')
            .toList();
      });
    }
  }
