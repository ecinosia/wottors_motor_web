...
class TurboD extends StatefulWidget {
  const TurboD({super.key});

  @override
  State<TurboD> createState() => _TurboDState();
}

class _TurboDState extends State<TurboD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Turbo')
            .toList();
      });
    }
  }
