...
class KasnakD extends StatefulWidget {
  const KasnakD({super.key});

  @override
  State<KasnakD> createState() => _KasnakDState();
}

class _KasnakDState extends State<KasnakD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Kasnak')
            .toList();
      });
    }
  }
