...
class SilindirKapagiD extends StatefulWidget {
  const SilindirKapagiD({super.key});

  @override
  State<SilindirKapagiD> createState() => _SilindirKapagiDState();
}

class _SilindirKapagiDState extends State<SilindirKapagiD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Silindir Kapağı')
            .toList();
      });
    }
  }
