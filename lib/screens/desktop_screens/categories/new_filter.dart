...
class SifirUrunlerD extends StatefulWidget {
  const SifirUrunlerD({super.key});

  @override
  State<SifirUrunlerD> createState() => _SifirUrunlerDState();
}

class _SifirUrunlerDState extends State<SifirUrunlerD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['status'] == 'Sıfır Orijinal')
            .toList();
      });
    }
  }
