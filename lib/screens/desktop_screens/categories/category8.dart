...
class VakumD extends StatefulWidget {
  const VakumD({super.key});

  @override
  State<VakumD> createState() => _VakumDState();
}

class _VakumDState extends State<VakumD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Vakum')
            .toList();
      });
    }
  }
