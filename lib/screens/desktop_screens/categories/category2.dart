...
class UstKapakD extends StatefulWidget {
  const UstKapakD({super.key});

  @override
  State<UstKapakD> createState() => _UstKapakDState();
}

class _UstKapakDState extends State<UstKapakD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Üst Kapak')
            .toList();
      });
    }
  }
