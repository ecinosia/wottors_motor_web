...
class YagKarteriD extends StatefulWidget {
  const YagKarteriD({super.key});

  @override
  State<YagKarteriD> createState() => _YagKarteriDState();
}

class _YagKarteriDState extends State<YagKarteriD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Yağ Karteri')
            .toList();
      });
    }
  }
