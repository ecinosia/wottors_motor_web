...
class MarsDinamosuD extends StatefulWidget {
  const MarsDinamosuD({super.key});

  @override
  State<MarsDinamosuD> createState() => _MarsDinamosuDState();
}

class _MarsDinamosuDState extends State<MarsDinamosuD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Marş Dinamosu')
            .toList();
      });
    }
  }
