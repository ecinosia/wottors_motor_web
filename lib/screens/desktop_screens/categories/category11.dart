...
class EnjektorD extends StatefulWidget {
  const EnjektorD({super.key});

  @override
  State<EnjektorD> createState() => _EnjektorDState();
}

class _EnjektorDState extends State<EnjektorD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Enjektör')
            .toList();
      });
    }
  }
