...
class SarjDinamosuD extends StatefulWidget {
  const SarjDinamosuD({super.key});

  @override
  State<SarjDinamosuD> createState() => _SarjDinamosuDState();
}

class _SarjDinamosuDState extends State<SarjDinamosuD> {
