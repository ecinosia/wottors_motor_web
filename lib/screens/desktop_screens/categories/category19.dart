...
class CikmaMotorD extends StatefulWidget {
  const CikmaMotorD({super.key});

  @override
  State<CikmaMotorD> createState() => _CikmaMotorDState();
}

class _CikmaMotorDState extends State<CikmaMotorD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Çıkma Motor')
            .toList();
      });
    }
  }
