...
class SifirMotorD extends StatefulWidget {
  const SifirMotorD({super.key});

  @override
  State<SifirMotorD> createState() => _SifirMotorDState();
}

class _SifirMotorDState extends State<SifirMotorD> {
