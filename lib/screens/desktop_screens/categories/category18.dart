...
class KapakD extends StatefulWidget {
  const KapakD({super.key});

  @override
  State<KapakD> createState() => _KapakDState();
}

class _KapakDState extends State<KapakD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Kapak')
            .toList();
      });
    }
  }
