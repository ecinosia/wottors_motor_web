...
class TesisatD extends StatefulWidget {
  const TesisatD({super.key});

  @override
  State<TesisatD> createState() => _TesisatDState();
}

class _TesisatDState extends State<TesisatD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Tesisat')
            .toList();
      });
    }
  }
