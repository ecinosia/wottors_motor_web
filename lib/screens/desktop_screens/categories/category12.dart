...
class UstKafesD extends StatefulWidget {
  const UstKafesD({super.key});

  @override
  State<UstKafesD> createState() => _UstKafesDState();
}

class _UstKafesDState extends State<UstKafesD> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Üst Kafes')
            .toList();
      });
    }
  }
