...
class SifirMotorM extends StatefulWidget {
  const SifirMotorM({super.key});

  @override
  State<SifirMotorM> createState() => _SifirMotorMState();
}

class _SifirMotorMState extends State<SifirMotorM> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Sıfır Motor')
            .toList();
      });
    }
  }
