...
class GazKelebegiM extends StatefulWidget {
  const GazKelebegiM({super.key});

  @override
  State<GazKelebegiM> createState() => _GazKelebegiMState();
}

class _GazKelebegiMState extends State<GazKelebegiM> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Gaz Kelebeği')
            .toList();
      });
    }
  }
