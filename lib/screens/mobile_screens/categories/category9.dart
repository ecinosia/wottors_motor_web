...
class SilindirKapakM extends StatefulWidget {
  const SilindirKapakM({super.key});

  @override
  State<SilindirKapakM> createState() => _SilindirKapakMState();
}

class _SilindirKapakMState extends State<SilindirKapakM> {
