...
class SanzimanM extends StatefulWidget {
  const SanzimanM({super.key});

  @override
  State<SanzimanM> createState() => _SanzimanMState();
}

class _SanzimanMState extends State<SanzimanM> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Şanzıman')
            .toList();
      });
    }
  }
