...
class PistonKoluM extends StatefulWidget {
  const PistonKoluM({super.key});

  @override
  State<PistonKoluM> createState() => _PistonKoluMState();
}

class _PistonKoluMState extends State<PistonKoluM> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Piston Kolu')
            .toList();
      });
    }
  }
