...
class NewProductFilter extends StatefulWidget {
  const NewProductFilter({super.key});

  @override
  State<NewProductFilter> createState() => _NewProductFilterState();
}

class _NewProductFilterState extends State<NewProductFilter> {
