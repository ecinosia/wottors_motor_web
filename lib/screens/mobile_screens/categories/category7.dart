...
class MazotPompasiM extends StatefulWidget {
  const MazotPompasiM({super.key});

  @override
  State<MazotPompasiM> createState() => _MazotPompasiMState();
}

class _MazotPompasiMState extends State<MazotPompasiM> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Mazot Pompası')
            .toList();
      });
    }
  }
