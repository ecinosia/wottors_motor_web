...
class SarjDinamosuM extends StatefulWidget {
  const SarjDinamosuM({super.key});

  @override
  State<SarjDinamosuM> createState() => _SarjDinamosuMState();
}

class _SarjDinamosuMState extends State<SarjDinamosuM> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Şarj Dinamosu')
            .toList();
      });
    }
  }
