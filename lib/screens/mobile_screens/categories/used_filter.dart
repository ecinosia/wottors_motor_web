...
class UsedProductFilter extends StatefulWidget {
  const UsedProductFilter({super.key});

  @override
  State<UsedProductFilter> createState() => _UsedProductFilterState();
}

class _UsedProductFilterState extends State<UsedProductFilter> {
