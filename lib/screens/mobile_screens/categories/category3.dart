...
class EmmeManifoldM extends StatefulWidget {
  const EmmeManifoldM({super.key});

  @override
  State<EmmeManifoldM> createState() => _EmmeManifoldMState();
}

class _EmmeManifoldMState extends State<EmmeManifoldM> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'Emme Manifoldu')
            .toList();
      });
    }
  }
