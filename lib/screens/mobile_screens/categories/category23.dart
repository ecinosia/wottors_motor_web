...
class YagKarteriM extends StatefulWidget {
  const YagKarteriM({super.key});

  @override
  State<YagKarteriM> createState() => _YagKarteriMState();
}

class _YagKarteriMState extends State<YagKarteriM> {
