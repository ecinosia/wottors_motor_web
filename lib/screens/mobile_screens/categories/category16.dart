...
class EgrM extends StatefulWidget {
  const EgrM({super.key});

  @override
  State<EgrM> createState() => _EgrMState();
}

class _EgrMState extends State<EgrM> {
  ...
  fetchDatabaseList() async {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList =
            resultant.where((product) => product['category'] == 'EGR').toList();
      });
    }
  }
