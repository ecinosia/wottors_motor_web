...
class ByPassM extends StatefulWidget {
  const ByPassM({super.key});

  @override
  State<ByPassM> createState() => _ByPassMState();
}

class _ByPassMState extends State<ByPassM> {
    ...
    if (resultant == null) {
      ...
      setState(() {
        productDetailList = resultant
            .where((product) => product['category'] == 'ByPass')
            .toList();
      });
    }
  }
